...
import { downloadPdfProfile, getMyProfileById } from "../../database/my_profile";
...
export default function ProfileRoot({ orgStructureId }) {
    ...
    const { data: indirectMembers, isLoading: _isLoadingIndirectMembers } = useQuery({
                    ...
                    <div className="flex lg:flex-col flex-row gap-2 lg:gap-0 justify-center lg:justify-start mt-4 px-4 lg:px-0">
                        {teamMembers?.length > 0 && (
                            <button
                                ...
                                title={profileActive ? `Direct Reporting (${teamMembers?.length})` : "My Profile"}
                            >
                        ...
                        {indirectMembers?.length > 0 && userProfile.dept_head !== 0 && (
                            <button
                            ...
                            >
                                ...
                                <span className="hidden lg:inline">
                                    Indirect Reporting ({indirectMembers.length})
                                </span>
                            </button>
                        )}
                        ...
                        {!userProfile?.is_admin && (
                            ...
                            >
                                <UserGroupIcon className="w-5 h-5 lg:hidden" />
                                <span className="hidden lg:inline">All Employees</span>
                            </button>
                        )}
                    </div>
                </div>

                <div className="flex-1 mt-4 md:mt-0 md:ml-6 bg-white border border-gray-200 rounded-lg lg:p-4 py-4">
