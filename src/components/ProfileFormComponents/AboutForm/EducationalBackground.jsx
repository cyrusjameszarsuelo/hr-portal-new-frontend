...
export default function EducationalBackground({
    ...
    const updateField = (index, field, value) => {
        dispatch({
            ...
            updater: (p) => ({
                ...p,
                educational_backgrounds: (p.educational_backgrounds || []).map(
                    (row, i) =>
    ...
    const toggleCurrent = (index, checked) =>
        updateField(index, "is_current", checked);
    ...
    const confirmRemove = (index) => {
        ...
        setConfirmState({
            ...
            message:
                "This will permanently remove the selected education record. Do you want to continue?",
            confirmLabel: "Remove",
            onConfirm: () => {
                dispatch({
                    type: "APPLY_UPDATER",
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-3 gap-3">
                                    ...
                                    <div className="md:col-span-3">
                                        ...
                                        <textarea
                                            ...
                                            className="mt-1 w-full rounded-md bg-white border border-gray-300 text-gray-900 focus:border-[#ee3124] focus:ring-[#ee3124] px-2 py-1.5 shadow-sm text-xs"
                                            placeholder="e.g., Magna Cum Laude, Debate Team, Chess Varsity, Best Thesis Award, Full Academic Scholar. Write NA if not applicable."
                                        />
                                    </div>
                                    <div>
                                        <label className="block text-xs font-medium text-gray-700">
